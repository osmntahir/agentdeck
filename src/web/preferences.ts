...
const defaults: Preferences = { theme: 'graphite', terminalColors: {}, notifications: true, previews: true, compact: true, sidebarCollapsed: false, mascot: true, colors: {}, lastProgram: {}, collapsedWorks: [], collapsedProjects: [] }
...
function read(): Preferences {
  try {
    ...
    for (const key of ['notifications', 'previews', 'compact', 'sidebarCollapsed', 'mascot'] as const) if (typeof raw[key] === 'boolean') result[key] = raw[key]
