...
10. **Trust kapısı — düzeltildi, genelleme daraltıldı.** Yeni klasörde trust/auth gerekebileceği anlatılır; insan onayı korunur. Üç CLI'ın her sürümde kesin olarak her worktree'de onay isteyeceği iddia edilmez. Bağımsız raporun kendi sınırı gereği doğrudan TUI kanıtı Claude'a aittir; diğerlerinin configuration gözlemi aynı güçte uçtan uca kanıt değildir.
11. **Okunamaz preview — düzeltildi, G1'e bağlı.** İlk rapordaki “bounded preview korunmalı” endorsement'ı içerik üretimi açısından geri çekildi. Poll/bütçe korunur; preview ANSI silerek değil headless hücrelerden üretilir. Sentetik sütun konumlandırma deneyi boşlukları korudu; gerçek CLI screenshot/preview kıyası G2'de.
